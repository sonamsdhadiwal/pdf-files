    ...
    <div className="home">
      ...
      <div className="main">
        <div class="home-title">
          <h1 class="title">Free Solution to all your word problems.Every tool you need to work with file covertor is all at one place.</h1>
        ...
        <div className="tools">
          <div className="tools__container col-md-12">
            {/* Merge Pdf */}
            <div className="tools__item col-md-3">
              <a href="/" title="Merge Pdf">
                <div className="tools__items__icon">
            ...
            {/* Split Pdf */}
            <div class="tools__item col-md-3">
